export const siteConfig = {
  ...
  description:
    "We waterproof homes and businesses in Hyderabad—terraces, roofs, basements, water tanks, bathrooms, and outer walls. Every job is inspected, planned properly, and covered by workmanship warranty where agreed.",
  ...
  email: process.env.NEXT_PUBLIC_SITE_EMAIL ?? "hello@hydroproofxpress.com",
  address: {
