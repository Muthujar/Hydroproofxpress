...
> = {
  ...
  teal: {
    topGlow: "from-transparent via-teal-400/90 to-transparent",
    iconWrap: "bg-teal-400/10 ring-teal-400/25",
    iconGlow: "bg-teal-400/25 shadow-[0_0_48px_-6px_rgba(45,212,191,0.5)]",
    ripple: "text-teal-400/20",
    wash: "from-teal-400/[0.07] via-transparent to-transparent",
    hoverRing: "group-hover:ring-teal-400/30",
    hoverShadow: "group-hover:shadow-[0_28px_56px_-16px_rgba(45,212,191,0.2),0_16px_40px_-20px_rgba(15,23,42,0.55)]",
  },
  emerald: {
    topGlow: "from-transparent via-emerald-400/90 to-transparent",
    iconWrap: "bg-emerald-400/10 ring-emerald-400/25",
    iconGlow: "bg-emerald-400/25 shadow-[0_0_48px_-6px_rgba(52,211,153,0.48)]",
    ripple: "text-emerald-400/20",
    wash: "from-emerald-400/[0.07] via-transparent to-transparent",
    hoverRing: "group-hover:ring-emerald-400/30",
    hoverShadow: "group-hover:shadow-[0_28px_56px_-16px_rgba(52,211,153,0.18),0_16px_40px_-20px_rgba(15,23,42,0.55)]",
  },
  amber: {
    topGlow: "from-transparent via-amber-400/90 to-transparent",
    iconWrap: "bg-amber-400/10 ring-amber-400/25",
    iconGlow: "bg-amber-400/25 shadow-[0_0_48px_-6px_rgba(251,191,36,0.45)]",
    ripple: "text-amber-400/20",
    wash: "from-amber-400/[0.07] via-transparent to-transparent",
    hoverRing: "group-hover:ring-amber-400/30",
    hoverShadow: "group-hover:shadow-[0_28px_56px_-16px_rgba(251,191,36,0.16),0_16px_40px_-20px_rgba(15,23,42,0.55)]",
  },
};
  ...
  return (
    <article
      className={cn(
        ...
        "border border-white/[0.09] bg-[#152536]/72 backdrop-blur-xl",
        "shadow-[0_20px_50px_-24px_rgba(15,23,42,0.55),0_8px_24px_-12px_rgba(15,23,42,0.35)]",
        "ring-1 ring-white/[0.04] transition-all duration-500 ease-out",
        "hover:-translate-y-2 hover:border-white/[0.14] max-sm:hover:translate-y-0",
        style.hoverRing,
        style.hoverShadow,
        staggered && "lg:mt-10"
      )}
