...
export function ContactSectionHome() {
  return (
    <section
      id="enquiry"
      className="scroll-mt-28 border-t border-border/80 bg-background py-16 md:py-20"
    >
      <div className="mx-auto grid min-w-0 max-w-7xl gap-10 px-4 sm:grid-cols-2 sm:gap-12 sm:px-6 lg:grid-cols-[1fr_1.08fr] lg:gap-x-12 lg:px-8">
        ...
        <FadeIn delay={0.06} className="min-w-0">
          <div className="rounded-2xl border-2 border-border bg-card p-6 shadow-xl shadow-black/[0.05] sm:p-7 md:p-9">
            <p className="mb-6 text-[1.04rem] leading-relaxed text-muted-foreground md:text-[1.06rem]">
              Add phone, building or area, and what you&apos;re seeing—we&apos;ll match the enquiry to the right crew.
            </p>
            <ContactEnquiryForm />
          </div>
        </FadeIn>
