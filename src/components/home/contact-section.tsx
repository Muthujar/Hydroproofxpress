...
export function ContactSectionHome() {
  return (
    <section
      id="enquiry"
      className="relative scroll-mt-28 overflow-hidden border-t border-border/80 bg-[#eef4fb] py-10 md:py-14"
    >
      <div
      ...
      <div className="relative mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid min-w-0 gap-6 md:grid-cols-2 md:gap-8">
          ...
          <FadeIn delay={0.05} className="min-w-0">
            <div className="rounded-2xl border border-border/80 bg-white p-6 shadow-lg shadow-slate-900/[0.06] sm:p-7">
